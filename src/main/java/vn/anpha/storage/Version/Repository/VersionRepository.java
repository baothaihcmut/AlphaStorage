...
public interface VersionRepository extends JpaRepository<Version, String> {
    ...
    @Query(value = """
            SELECT
                ...
                LIMIT 1
            """, nativeQuery = true)
    Optional<VersionDTO> findVersionById(@Param("versionId") String versionId);
    ...
    @Query(value = """
            SELECT
                ...
                LIMIT 1
            """, nativeQuery = true)
    Optional<VersionDetailDTO> findVersionDetailById(@Param("versionId") String versionId);
    ...
    @Modifying
    @Query(value = """
            DELETE FROM versions WHERE file_id=:fileId
            """, nativeQuery = true)
    void deleteAllVersionOfFile(@Param("fileId") String fileId);
