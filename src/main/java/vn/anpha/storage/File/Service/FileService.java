...
// FileDTO fileDetailProjection =
// this.fileDetailRepository.findFileDetailById(fileId)
...
// FileExistProjection fileExistProjection =
// this.fileRepository.findFileById(fileId, true)
...
// this.companyService.removeFileCompany(UUID.fromString(fileDetail.getBucketName()),
// fileDetail.getSize());
// this.storageService.removeFile(fileDetail.getBucketName(),
// fileDetail.getLink());
// }
// }
