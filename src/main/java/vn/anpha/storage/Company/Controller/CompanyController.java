...
public class CompanyController {
    ...
    @PostMapping("/create")
    ApiResponseDto<CompanyResponse> createCompany(@RequestBody CompanyCreationRequest request) {
    ...
    @PostMapping("/update")
    ApiResponseDto<CompanyResponse> updateCompany(@RequestBody CompanyUpdateRequest request) {
        return ApiResponseDto.<CompanyResponse>builder()
