...
// // .andExpect(MockMvcResultMatchers.jsonPath("key In json").value("value
// key"));
...
// .andExpect(MockMvcResultMatchers.jsonPath("message").value("fullName
// minLength=3 and maxLength=50"));
// ;
// }
// }
